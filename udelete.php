...
<div class="link">
<pre>   <a href="contact.php">Home</a>        <a href="view.php">View Info</a>        <a href="insert.php">insert</a>        <a href="update.php">Update</a>        <a href="delete.php">Delete</a>        <a href="user.php">User</a></pre>
</div>
<div class="middle">
<p align="center">
<?php 
...
if("submit")
{
$sql=mysql_query("delete from info where name='".$name."'");
mysql_query($sql);
}
mysql_close($con);
?>
<h2 align="center">Delete Successful!!!</h2></br>
<a href="update.php">Delete another??</a>
